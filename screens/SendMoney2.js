        ...
        <View style={{ flex: 1 }}>
            ...
            <View style={{ flex: 1, backgroundColor: '#F4F4F5' }}>
                <View style={{ marginHorizontal: 15, flex: 1 }}>
                    ...
                    <View style={{ marginTop: 10 }}>
                        ...
                        <TextInput
                            ...
                            style={{ fontSize: 14, backgroundColor: '#FFFFFF', paddingVertical: 5, paddingLeft: 15 }}
                        />
                    </View>
                    <View style={{ marginTop: 10 }}>
                ...
                <View style={{ alignItems: 'center', marginBottom: 44 }}>
                    <ButtonCus onPress={() => navigation.navigate('TransferSuccess')} tit={'Next'} />
                </View>
            </View>
        </View>
    );
